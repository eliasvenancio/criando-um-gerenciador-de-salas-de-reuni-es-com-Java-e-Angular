...
public class RoomController<value, updateRoom> {
    ...
    @GetMapping("/rooms/{id})
            public ResponseEntity<Room> getRoombyId(PathVariable(value="id")
            long roomId)
    ...
    public ResponseEntity<Room> updateRoom(@PathVariable(value = "id") Long roomId,
                                           @Valid @RequestBody roomDetails) throws ResourceNotFoundException
